        ...
        $gridColumns = [
            ...
            [
                ...
                'content' => function ($model, $key, $index, $column) {
                    if($_SERVER['REQUEST_URI']==Yii::$app->params['requestPath'] . '/user') {
                        $refreshLink = "user/index?" . $_SERVER['QUERY_STRING'];
                    } else {
                    ...
                    ob_start(); //start a new buffer to convert as string
                        Modal::begin([
                            ...
                            echo '<iframe style="width:100%; height: 700px" src="' . Yii::$app->params['viewPageBaseUrl'] . '/user/view?id=' . $model->id . '"></iframe>';
...
<?php
    ...
    ob_start(); //start a new buffer to convert as string
        ...
        echo '<iframe style="width:100%; height: 700px" src="' . Yii::$app->params['viewPageBaseUrl'] . '/user/create' .  '"></iframe>';
...
<?php
    ...
    echo GridView::widget([
        ...
        'toolbar' =>  [
            ['content'=>
                Html::button('<i class="glyphicon glyphicon-plus"></i>', ['type'=>'button', 'title'=>'Add User', 'class'=>'btn btn-success', 'onclick'=>'window.location.assign("' . Yii::$app->params['requestPath'] . '/user/create")']) . ' '.
